...
**Key lineage notes:**
- The accepted M2 specs we reviewed together (**M2-01** Plan/Build, **M2-02** Orchestration, **M2-03** Extract-load, **M2-07** Brownfield, **M2-10** FastAPI) all stay where they are at [`specs/_archive/milestone-2-real-product/`](../_archive/milestone-2-real-product/). M2-01 and M2-03 directly source pillar-1 specs; the others slot into later pillars (Pillar 2 for M2-07; UI milestone for M2-10) or get reframed (Pillar 2+ absorbs M2-02 when there are multiple specialists to orchestrate).
- The **M2-14 proposal** is parked in place ([`_spec_update_proposal_M2-14.md`](../_archive/milestone-2-real-product/_spec_update_proposal_M2-14.md)) as historical context for the deploy discussion. It is explicitly *not* accepted; P1-08 supersedes it with a leaner OSS-flexible reframe.
