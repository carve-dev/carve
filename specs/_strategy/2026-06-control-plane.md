...
- `specs/v0.1/03-flat-layout.md` (add `[el]` topology symmetric with dbt; `carve.toml` → control-plane config)
- `specs/v0.1/04-el-agent-dlt.md` (authors into a component, not fused `el/`)
- `specs/v0.1/08-multi-step-pipeline.md` (binding contract gains versioned references)
- `specs/v0.1/14-deploy-pr.md` (control-plane-aware; cross-repo coordination first-class; reconcile `el deploy`)
- `specs/v0.1/02-oss-packaging.md`, `05-init-rewrite.md`, `13-reference-docs.md` (init scaffolds a control plane + optional simple-mode; config schema)
